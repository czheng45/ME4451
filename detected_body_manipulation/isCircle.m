...
%        MinorAxisLength. Default X = 15%
%     2) comparing if the EquivDiameter is within X% above or below the
%        MajorAxisLength. Default, 15%. (15% above or 15% below)
%
%INPUT ARGUMENTS
%   bodies:
...
%       is a circle. By default, X = 15% (see DESCRIPTION) above. If empty,
%       uses the default value of 15%, or 0.15.
%
